...
\custsetup{
  ...
  advisor            = {XXX研究院AAA~研究员},%企业导师中文，只有专业学位论文，该语句才起作用。其余论文可以不写
%  advisor*           = {Prof. AAAA},%企业导师英文，《研究生规范》暂未对企业导师英文做规定，因此注释掉
  degree-area*       = {Master of Engineering},%硕士类型英文，工学硕士，理学说是为Master of Science,博士学位为Doctor of Philosophy
  start-date         = {2017年11月}, %论文的初始时间
